    ...
    <div>
      ...
      <div className="industry-grid-container">
        <div className="grid">
          ...
          <IndustryCard title="Smart Highway" icon={<FaRoad size={50} className="multicolor-icon" />} link="http://localhost:8080/smartHighway" />
          <IndustryCard title="Smart Parking" icon={<MdLocalParking size={50} className="icon-color-1" />} link="http://localhost:8080/smartHome" />
          <IndustryCard title="Smart Energy Management" icon={<MdPower size={50} className="icon-color-2" />} link="http://localhost:8080/smartHome" />
        </div>
      </div>
    </div>
  );
