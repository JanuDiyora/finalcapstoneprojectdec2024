...
public class ROICalculationTransit {
    ...
    public ROICalculationTransit(BigDecimal roi, BigDecimal totalOperationalCost, BigDecimal totalAvenue, BigDecimal totalInvestment) {
        this.roi = roi;
