...
public class ROICalculationTraffic {
    ...
    public ROICalculationTraffic(BigDecimal roi, BigDecimal totalOperationalCost, BigDecimal totalAvenue, BigDecimal totalInvestment) {
        this.roi = roi;
