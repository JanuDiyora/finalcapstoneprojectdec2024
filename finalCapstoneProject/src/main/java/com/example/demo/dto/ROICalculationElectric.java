...
public class ROICalculationElectric {
    ...
    public ROICalculationElectric(BigDecimal roi, BigDecimal totalOperationalCost, BigDecimal totalAvenue, BigDecimal totalInvestment) {
        this.roi = roi;
