...
public class ROICalculationParking {
    ...
    public ROICalculationParking(BigDecimal roi, BigDecimal totalOperationalCost, BigDecimal totalAvenue, BigDecimal totalInvestment) {
        this.roi = roi;
