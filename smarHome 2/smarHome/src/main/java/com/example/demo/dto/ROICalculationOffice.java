...
public class ROICalculationOffice {
	 private BigDecimal roi;
	    private BigDecimal totalOperationalCost;
	    private BigDecimal totalAvenue;
	    private BigDecimal totalInvestment;

	    public ROICalculationOffice(BigDecimal roi, BigDecimal totalOperationalCost, BigDecimal totalAvenue, BigDecimal totalInvestment) {
	        this.roi = roi;
