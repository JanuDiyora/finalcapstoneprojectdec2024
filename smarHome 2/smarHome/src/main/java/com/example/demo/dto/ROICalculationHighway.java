...
public class ROICalculationHighway {
    ...
    public ROICalculationHighway(BigDecimal roi, BigDecimal totalOperationalCost, BigDecimal totalAvenue, BigDecimal totalInvestment) {
        this.roi = roi;
